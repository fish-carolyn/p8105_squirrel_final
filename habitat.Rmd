...
Based on this output, we see that almost all of our results are statistically significant at the 5% level. Woohoo! Based on this output, we see that almost all of our results are statistically significant at the 5% level. Woohoo! A squirrel spotted on the ground plane is most likely to be seen running, climbing, eating, or foraging. The effect of chasing was not statistically significant at the 0.05 level. Squirrels spotted on the ground plane also have a likelihood to be spotted at night.
