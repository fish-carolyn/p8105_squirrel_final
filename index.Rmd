...
```{r, echo=FALSE, out.width="60%", fig.cap="One of Central Park's many furry residents", fig.align = 'center'}
...
map_squirrels 
```
Hover over each point on the map to learn more about the squirrel spotted at that location!
