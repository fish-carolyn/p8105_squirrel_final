...
In terms of communication, we wanted to see if there were any trends in the sounds made by squirrels and the activities they were engaged in. Using several plots and graphs, we discovered that there were no obvious relationships between the sounds that squirrels make and their interactions with humans or engagement in certain activities. 

In summary, after performing exploratory analyses, primarily in the form of visualizations, there did not appear to be as much spatial or physical variation in Central Park squirrels as we had initially thought. For example, the vast majority of squirrels are adults with gray fur, and they appear to engage in all activities in all areas of the park. Most squirrels do not engage with humans, and they make the same sounds regardless of the activity they are engaged in. As a result, we decided to focus more on visualizations and interactivity, particularly in the form of maps.
...
Overall, we found that squirrels are relatively similar throughout the park, both demographically and in terms of behavior. There are no observable trends between squirrel ages and primary fur colors, and squirrels are observed engaing in all activities in all areas of the park. Squirrels also make the same sounds regardless of maturity or activity. 

From our statistical analyses, we found that there is a significant association between the time of day and the location where squirrels are observed. Additionally, a squirrel spotted on the ground plane is most likely to be seen running, climbing, eating, or foraging.

Our project also includes an interactive map created with Shiny to enable viewers to explore the spatial distribution of squirrels with various combinations of attributes. The map includes landmarks and streets of Central Park so that specific locations can be recognized. Although there does not appear to be many obvious trends from our analysis of Central Park squirrels, a goal of our project is for viewers to be able to make their own insights based on recognizable locations of the park. We hope that viewers will be able to walk away with more awareness of the squirrels in their surroundings during their next visit to the park.
