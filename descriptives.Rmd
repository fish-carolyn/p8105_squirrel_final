...
We can see that most squirrels in Central Park have Gray fur with some Cinnamon or White accents (above). Squirrels that are black with any accent colors are very rare! Consider yourself lucky if you've ever seen one of them frolicking in the park! 
...
```{r, echo=FALSE, out.width="80%", fig.align='center'}
knitr::include_graphics("./pictures/black_squirrel.jpeg")
```
...
The squirrel census did not report any difference in fur color by the age of the squirrel (left). Among both the young and the old, gray squirrels dominate the counts!
