...
The raw dataset, we utilized can be found here [here](https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-10-29). Our cleaned squirrel census dataset includes 2,824 observations and includes the following variables:
