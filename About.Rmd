...
The raw dataset we utilized can be found  [here](https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-10-29). Our cleaned squirrel census dataset has 2,824 observations and includes the following variables:
